...
class ProductScreenTopPart extends StatefulWidget {
  ...
  const ProductScreenTopPart({Key? key, this.child}) : super(key: key);
...
class ProductScreenBottomPart extends StatefulWidget {
  ...
  const ProductScreenBottomPart({Key? key, this.child}) : super(key: key);
...
Widget sizeItem(String size, bool isSelected, BuildContext context) {
  return Padding(
    ...
    child: Container(
      ...
      height: screenAwareSize(30.0, context),
      decoration: BoxDecoration(
          color: isSelected ? const Color(0xFFFC3930) : const Color(0xFF522663),
          borderRadius: BorderRadius.circular(5.0),
          boxShadow: [
            BoxShadow(
